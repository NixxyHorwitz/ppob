...
.nav-kategori { display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px; }
.tab-item { 
    flex: 1 0 calc(25% - 10px); text-align: center; background: white; padding: 10px; 
    border-radius: 12px; border: 1px solid #e2e8f0; color: #64748b; 
...
.input-custom { 
    background-color: #f1f5f9; border: 2px solid transparent; border-radius: 12px; 
    padding: 12px 15px; font-weight: 600; transition: 0.3s;
}
.input-custom:focus { background-color: #fff; border-color: var(--sky-blue); box-shadow: none; }
.btn-navy { background-color: #134d74; color: white; border: none; border-radius: 15px; font-weight: 700; transition: 0.3s; }
.btn-navy:hover { background-color: #1e5f8a; color: #fff; }
.info-tagihan { background: #f0f9ff; border: 1px dashed var(--sky-blue); padding: 15px; border-radius: 12px; }
.main-content { margin-left: 260px; transition: all 0.3s ease; }
@media (max-width: 768px) { .main-content { margin-left: 0; } .tab-item { flex: 0 0 calc(50% - 10px); } }
</style>
